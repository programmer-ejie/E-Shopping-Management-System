...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main" style = "background-color: #1a4d2e;">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white " href="export.php" style = "background-color: #e8dfca;">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10" style = "color: black;">dashboard</i>
            </div>
            <span class="nav-link-text ms-1" style = "color: black; font-weight: bold;">EXPORT</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">EXPORT</h6>
        </nav>
      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <div class="card-footer p-3">
                      <a href="ExportItems.php"  class  = "btn btn-success" style = "margin-bottom: 0px;">EXPORT</a>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
             <a href="ExportBuyer.php"  class  = "btn btn-success" style = "margin-bottom: 0px;">EXPORT</a>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
            <a href="ExportSeller.php"  class  = "btn btn-success" style = "margin-bottom: 0px;">EXPORT</a>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
            <a href="ExportRates.php"  class  = "btn btn-success" style = "margin-bottom: 0px;">EXPORT</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row" style = "margin-top: 70px;">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
            <a href="ExportCarts.php"  class  = "btn btn-success" style = "margin-bottom: 0px;">EXPORT</a>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
            <a href="ExportPending.php"  class  = "btn btn-success" style = "margin-bottom: 0px;">EXPORT</a>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
            <a href="ExportStatus.php"  class  = "btn btn-success" style = "margin-bottom: 0px;">EXPORT</a>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
            <a href="ExportComplete.php"  class  = "btn btn-success" style = "margin-bottom: 0px;">EXPORT</a>
            </div>
          </div>
        </div>
      </div>
